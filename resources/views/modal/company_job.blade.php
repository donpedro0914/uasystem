	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="menuForm" action="{{ route('company.jobs.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="form-row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 col-xs-12">
                                    <label>Company</label>
                                    <input type="text" class="form-control" name="company" value="{{ Auth::user()->name }}" readonly/>
                                </div>
                                <div class="form-group col-md-12 col-xs-12">
