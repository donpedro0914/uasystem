                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <div class="sticky-table-header">
                                    <table id="table" class="table table-bordered dataTable no-footer table-striped ajax-jobs">
                                        ...
                                        <tbody>
                                            @foreach(App\Jobs::where('company', Auth::user()->name)->get() as $j)
                                            <tr class="text-center">
                                                <td>{{ $j->job_title }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('company.jobs.edit', ['id'=>$j->id]) }}" class="btn btn-xs btn-default btn-edit"><i class="mdi mdi-pencil"></i></a>
